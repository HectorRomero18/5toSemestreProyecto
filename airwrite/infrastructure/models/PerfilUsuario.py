...
class PerfilUsuario(models.Model):
    ...
    letras_practicadas = models.ManyToManyField(
        'Letra',
        blank=True
    )
    letras_desbloqueadas = models.ManyToManyField(
        'Letra',
        related_name='usuarios_desbloqueados',
        blank=True
    )

    silabas_practicadas = models.ManyToManyField(
        'Silaba',
        blank=True
    )
    silabas_desbloqueadas = models.ManyToManyField(
        'Silaba',
